...
import org.codemash.runnerz.ui.views.runlist.RunListView;
//import org.codemash.runnerz.ui.views.runform.RunFormView;
...
public class MainLayout extends AppLayout {
    ...
    private AppNav createNavigation() {
        ...
        nav.addItem(new AppNavItem("Run Form", RunFormView.class, "la la-user"));
        nav.addItem(new AppNavItem("Run Log", RunListView.class, "la la-filter"));
